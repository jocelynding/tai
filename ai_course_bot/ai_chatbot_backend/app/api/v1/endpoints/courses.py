...
from ..schemas.course import CoursesResponse
from ..schemas.course import Meta as CoursesMeta
from ..schemas.file import FilesResponse
from ..schemas.file import Meta as FilesMeta
from ..services import courses_service, files_service
...
def get_course_files(
    ...
    files, total = files_service.get_course_files(
        courseId=courseId, folder=folder, page=page, limit=limit, user=user
    )
    total_pages = (total + limit - 1) // limit
